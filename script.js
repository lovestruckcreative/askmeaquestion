document.addEventListener('DOMContentLoaded', (event) => {
    const questions = [
        ...
        "What's your process for understanding a couples vision for their day?",
    ...
    showQuestionButton.addEventListener("click", function() {
        ...
        questionParagraph.innerText = questions[currentIndex++];
    });

    const copyQuestionButton = document.getElementById("copyQuestionButton");

    copyQuestionButton.addEventListener("click", function() {
        const questionText = questionParagraph.innerText;
